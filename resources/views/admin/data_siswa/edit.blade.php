                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-1/2 px-8" x-data="{ 
                        formData: {
                            ...
                            nis_id: '{{ $data_siswa->nis_id }}',
                            gender: '{{ $data_siswa->gender }}'
                        },
                        isSubmitting: false
                    }">
                        <div class="max-w-md mx-auto">                
                            <form action="{{ url('data_siswa/' . $data_siswa->id) }}" method="post" 
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="nis_id" 
                                           name="nis_id" 
                                           value="{{ old('nis_id', $data_siswa->nis_id) }}"
                                ...
                                <div class="pt-4">
                                    <button type="submit" 
                                        ...
                                        <span x-show="!isSubmitting">Update Data</span>
