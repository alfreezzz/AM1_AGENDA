                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition duration-150" x-data="{ attendance: '{{ $absen_siswa->keterangan }}' }">
                                <td class="px-6 py-4 text-gray-500 text-center">1</td>
                                <td class="px-6 py-4 font-medium text-gray-800">{{ $absen_siswa->data_siswa->nama_siswa }}</td>
                                <td class="px-6 py-4">
